...
<?php 
   ...
   $rs = $dbh->query($sql);
    ...
    $sql_delete = "DELETE pelanggan WHERE id=1"
   $delete = $dbh->query($sql_delete)
?>
                ...
                ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a class="btn btn-primary" href="<?= $delete ?>" onclick="if(!confirm('Anda Yakin Hapus Data Produk <?=$row['nama']?>?')) {return false}">Delete</a>
                        </td>
                    </tr>
                <?php 
                $nomor++;   
